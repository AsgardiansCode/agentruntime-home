          ...
          {plans.map((plan, index) => {
            ...
            return (
              <ScrollReveal key={plan.name} variant="fade-up" delay={index * 150}>
                <Card className={`relative card-gradient hover-lift transition-all duration-300 h-full ${plan.popular ? 'ring-2 ring-primary scale-105' : ''}`}>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={faq.q} className="bg-gradient-card p-6 rounded-lg">
